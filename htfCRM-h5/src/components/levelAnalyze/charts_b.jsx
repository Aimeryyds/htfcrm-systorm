...
class ChartsA extends Module {
    ...
    renderEcharts() {
        ...
        let myChart = echarts.init(document.getElementById('chartsB_bar'));
    ...
    render() {
        ...
        return <div className="custrend">
            ...
            <div className="color_ui fs_16 bg_ui_2 mt_10" style={{display: 'inline-block', lineHeight: '36px', padding: '0 20px 0 10px', borderRadius: '0 18px 18px 0'}}>
                { titleMap[this.props.level] }客户数<span className="iconfont icon-kgengduo"></span>
            </div>
            </Item></Picker>
            <div id="chartsB_bar" style={{width: '100%', height: '250px'}}></div>
            <WhiteSpace size='lg'/>
        </div>
    }
}
