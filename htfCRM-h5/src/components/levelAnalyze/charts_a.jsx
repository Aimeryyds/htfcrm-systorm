...
class ChartsA extends Module {
    ...
    renderEcharts() {
        let { chartsListA, timeIndex } = this.props, options = {};
        
        let myChart = echarts.init(document.getElementById('chartsA_bar')), legendData;
        switch(timeIndex){
    ...
    render() {
        return <div>
            <div id="chartsA_bar" style={{width: '100%', height: '270px', paddingBottom: '20px'}}></div>
        </div>
    }
}
