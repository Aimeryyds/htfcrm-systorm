...
class ChartA extends Module{
    ...
    renderEcharts(){
        let data = this.props.data, oridata = [
        ...
        let myChart = echarts.init(document.getElementById("Pie_a"));
        let options = {
            title:{
                text:"分派客户数\n及占比",
                left:'center',
        ...
        myChart.on("click", (params) => {
            ...
            this.props.changeCurCusType(params.name, params.value);
        })
    }
    render(){
        return <div id="Pie_a" style={{width: '100%', height: '350px', paddingBottom: '20px'}}></div>
    }
