        ...
        return <div className="N_customer_List">
            ...
            >
                ...
                <SearchBar
                    ...
                    onClear={() => { this.setState({searchValue: '', pageIndex: 1},()=> this.getFundManagersList()) }}
                    onCancel={() => { this.setState({searchValue: '', pageIndex: 1},()=> this.getFundManagersList()) }}
