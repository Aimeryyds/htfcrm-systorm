 ...
 * @Last Modified time: 2019-02-26 14:07:53
 */
        ...
        <div style={{overflowX: 'scroll'}}>
            ...
            <thead>
                <tr>
                    ...
                    <th className={flags[1]!= -1 ? "sorted" : ''} onClick={()=>this.props.handleSort(2)}>降级客户数<sapn className={flags[1] == -1 ?"iconfont icon-paixumoren" :flags[1] == 0 ? 'iconfont icon-shengxu' : 'iconfont icon-jiangxu'}></sapn></th>
                    <th  className={flags[2]!= -1 ? "sorted" : ''} onClick={()=>this.props.handleSort(3)}>降级率<sapn className={flags[2] == -1 ?"iconfont icon-paixumoren" :flags[2] == 0 ? 'iconfont icon-shengxu' : 'iconfont icon-jiangxu'}></sapn></th>
